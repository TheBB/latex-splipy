...
\begin{figure}
  \begin{center}
    ...
    \subfloat[\textbf{Loft:} interpolates a given set of curves]{
      \label{fig:loft}
      \includegraphics[height=.28\textwidth]{figs/loft}
    }
    \caption{\textbf{surface\_factory:} splipy follows a bottom-up design principle where surfaces tyically are constructed from defining curves}
  \end{center}
\end{figure}
